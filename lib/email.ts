...
export async function sendConfirmationEmail(data: ConfirmationEmailData) {
  ...
  const { error } = await resend.emails.send({
    from: "Kingdom Restoration Conference <noreply@yourdomain.com>", // Update with your verified domain
    to: data.to,
    subject: isVendor
      ...
      <html>
        ...
        <body style="font-family: Georgia, serif; background-color: #F5EFE6; padding: 40px 20px; margin: 0;">
          <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <div style="background-color: #2C1150; padding: 30px; text-align: center;">
            ...
            <div style="padding: 40px 30px;">
              <h2 style="color: #2C1150; margin-top: 0;">${isVendor ? "Vendor Table Confirmed!" : "Registration Confirmed!"}</h2>
              ...
              <div style="background-color: #F5EFE6; border-left: 4px solid #789848; padding: 20px; margin: 30px 0;">
                <h3 style="color: #2C1150; margin-top: 0;">Event Details</h3>
              ...
              <h3 style="color: #2C1150;">Hotel Accommodations</h3>
              <p style="color: #333; line-height: 1.6;">
              ...
              <p style="margin: 20px 0;">
                <a href="https://groups.hilton.com/search-events/ca24f4c7-9edd-4c66-8337-d113947a321d/property/28838b5e-80d3-4ac3-a671-9e6f3f65a64c?search_type=redirect"
                   style="background-color: #789848; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block;">
                  Book Your Room
                </a>
              </p>

              <h3 style="color: #2C1150;">What to Expect</h3>
            ...
            <div style="background-color: #2C1150; padding: 20px; text-align: center;">
